...
const botname = process.env.BOTNAME || 'JASON MOMANYI𓅃';
const antibot = process.env.ANTIBOT || 'FALSE';
    ...
    const author = process.env.STICKER_AUTHOR ||'JASON M™𝕏';
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: 'https://wa.me/923195832822?text=ʜᴇʟʟᴏ+𝐈𝐭𝐬_JASON™𝕏+Nihostie+Bot+Mkuu+🥲',
                                mediaType: 1,
...
await m.reply('Successfully removed!'); 
 ...
 client.sendMessage(m.chat, { image: { url: `https://telegra.ph/file/4f5eb47c4211fd637ebe0.png` }, caption: 
...
case "alive": { 
 ...
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/e32da47adb1371aa6031e.mp4' }, caption: `Hello ${m.pushName}, 𝐂𝐑𝐎𝐖𝐍 is alive since  ${runtime(process.uptime())}`, fileLength: "9999999999898989899999999" }, { quoted: m }); 
 }
break;
case 'apk': {
...
case "movie": 
    ...
    break;
         ...
         for (let i of res) { 
             ...
             await client.sendMessage(i, { 
                 image: { 
                     url: "https://telegra.ph/file/e32da47adb1371aa6031e.mp4" 
                 }, 
                 caption: `${txt}` 
             }) 
         } 
 ...
 break;
        ...
        case "gpt": case "g": 
            ...
            if (!text) return reply("Hello am 𝐂𝐑𝐎𝐖𝐍 an Ai developed by JASON MOMANYI₪, how can I help you today?");
