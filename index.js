...
let botname = process.env.BOTNAME || 'JASON MOMANYI𓅃-𝐀𝐈: ';

const owner = process.env.DEV || '25479988426'; // This will send a notification once the bot reconnects
const {
...
if (autobio === 'TRUE'){ 
            setInterval(() => { 
                         ...
                         client.updateProfileStatus( 
                                         ...
                                         `HAIL TO ${botname}\n\n${date.toLocaleString('en-US', { timeZone: 'Africa/Nairobi' })} It's a ${date.toLocaleString('en-US', { weekday: 'long', timeZone: 'Africa/Nairobi'})}. #JasonMomanyi©2024` 
